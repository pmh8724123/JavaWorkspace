...
public class A_Variable {
	...
	public void printVariable() {
		...
		System.out.println("박무혁 : " + 8500 * 6 * 5);
		System.out.println("박무혁1 : " + 8500 * 6 * 5);
		System.out.println("박무혁2 : " + 8500 * 6 * 5);
		System.out.println("박무혁3 : " + 8500 * 6 * 5);
		
		int pay = 9000;
		int time = 6;
		int day = 5;
		
		System.out.println("박무혁 : " + pay * time * day);
		System.out.println("박무혁1 : " + pay * time * day);
		System.out.println("박무혁2 : " + pay * time * day);
		System.out.println("박무혁3 : " + pay * time * day);
		/*
		 * 변수를 사용하는 이유
		 * 1. 가독성 확보
		 * 2. 재사용성 증대
	...
	public void declareVariable() {
		...
		// 4. 문자열(참조자료형)
		 ...
		 // 변수에 값을 대입하는 행위 == 초기화
		 // 자바(java)에서는 변수를 반드시 초기화 하고 사용해야한다.
