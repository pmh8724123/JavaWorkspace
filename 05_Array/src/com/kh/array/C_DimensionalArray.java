...
//		[0,0,0,0,0]
		...
		System.out.println(arr); // 2차원배열의 주소값. [[I@6504e3b2
		System.out.println(arr[0]); // 1행의 주소값 [I@379619aa
		System.out.println(arr[0][0]);// 1행 1열의 값(0) 0
...
//		- 이차원배열은 1차원배열을 여러개 묶음으로 관리하는 형태긴 하지만, 
//		  크기가 꼭 같을 필요는 없음.
